        ...
        mDatabase.child("Users")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (aux >= 0) {
                            tvUser1.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser2.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser3.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser4.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser5.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser6.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser7.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser8.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser9.setText(score.get((aux)).getName());
                        ...
                        if (aux >= 0) {
                            tvUser10.setText(score.get((aux)).getName());
